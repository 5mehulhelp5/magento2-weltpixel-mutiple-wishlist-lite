# magento2-weltpixel-mutiple-wishlist-lite
...
$ composer config repositories.weltpixel-magento2-weltpixel-mutiple-wishlist-lite git https://github.com/Weltpixel/magento2-weltpixel-mutiple-wishlist-lite.git
$ composer require weltpixel/magento2-weltpixel-mutiple-wishlist-lite:dev-master
```
...
Copy the zip into the app/code/WeltPixel/AdvancedWishlist directory.
...
For detailed documentation, please visit: https://weltpixel.com/resources/ModuleDoc/Magento2/AdvancedWishlist/User-Guide-WeltPixel-AdvancedWishlist.html
